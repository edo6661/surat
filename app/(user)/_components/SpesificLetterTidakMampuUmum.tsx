...
interface SpesificLetterTidakMampuUmumProps {
  letter: any;
  role: Role
}

const SpesificLetterTidakMampuUmum = (
  { letter, role }: SpesificLetterTidakMampuUmumProps
) => {

  const generatePdf = async () => {
    if (!letter || !letter.tidakMampu) return;
    ...
    const documentDefinition = {
      ...
      content: [
        ...
        { text: 'Surat Keterangan Tidak Mampu', style: 'subheader', alignment: 'center', decoration: 'underline' },
        ...
        { text: `Nama: ${letter.tidakMampu.nama}`, style: 'normal', margin: [16, 12, 0, 0] },
        { text: `NIK: ${letter.tidakMampu.nik}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tempat Lahir: ${letter.tidakMampu.tempatLahir}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tanggal Lahir: ${formatDate(letter.tidakMampu.tanggalLahir)}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Agama: ${letter.tidakMampu.agama}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Pekerjaan: ${letter.tidakMampu.pekerjaan}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Alasan Tidak Mampu: ${letter.tidakMampu.alasanTidakMampu}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Pendapatan: ${letter.tidakMampu.pendapatan}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Alamat: ${letter.tidakMampu.alamat}`, style: 'normal', margin: [16, 8, 0, 12] },
    ...
    pdfMake.createPdf(documentDefinition).download(
      `${letter.tidakMampu.nama}_SuratKeteranganTidakMampu.pdf`
    );
  };
...
export default SpesificLetterTidakMampuUmum