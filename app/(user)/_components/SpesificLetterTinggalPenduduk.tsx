...
interface SpesificLetterTinggalPendudukProps {
  letter: any;
  role: Role
}

const SpesificLetterTinggalPenduduk = (
  { letter, role }: SpesificLetterTinggalPendudukProps
) => {

  const generatePdf = async () => {
    if (!letter || !letter.tinggalPenduduk) return;
    ...
    const documentDefinition = {
      ...
      content: [
        ...
        { text: 'Surat Keterangan Tinggal Penduduk', style: 'subheader', alignment: 'center', decoration: 'underline' },
        ...
        { text: `Nama Pemohon: ${letter.tinggalPenduduk.nama}`, style: 'normal', margin: [16, 12, 0, 0] },
        { text: `NIK: ${letter.tinggalPenduduk.nik}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Alamat Asal: ${letter.tinggalPenduduk.alamatAsal}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Alamat Sekarang: ${letter.tinggalPenduduk.alamatSekarang}`, style: 'normal', margin: [16, 8, 0, 12] },
    ...
    pdfMake.createPdf(documentDefinition).download(
      `${letter.tinggalPenduduk.nama}_SuratKeteranganTinggalPenduduk.pdf`
    );
  };
...
export default SpesificLetterTinggalPenduduk