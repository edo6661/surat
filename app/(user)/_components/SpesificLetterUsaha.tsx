...
interface SpesificLetterUsahaProps {
  letter: any;
  role: Role
}

const SpesificLetterUsaha = (
  { letter, role }: SpesificLetterUsahaProps
) => {

  const generatePdf = async () => {
    if (!letter || !letter.keteranganUsaha) return;
    ...
    const documentDefinition = {
      ...
      content: [
        ...
        { text: 'Surat Keterangan Usaha', style: 'subheader', alignment: 'center', decoration: 'underline' },
        ...
        { text: `Nama: ${letter.keteranganUsaha.nama}`, style: 'normal', margin: [16, 12, 0, 0] },
        { text: `NIK: ${letter.keteranganUsaha.nik}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tempat Lahir: ${letter.keteranganUsaha.tempatLahir}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tanggal Lahir: ${formatDate(letter.keteranganUsaha.tanggalLahir)}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Agama: ${letter.keteranganUsaha.agama}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Pekerjaan: ${letter.keteranganUsaha.pekerjaan}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Lokasi Usaha: ${letter.keteranganUsaha.lokasiUsaha}`, style: 'normal', margin: [16, 8, 0, 0] },
    ...
    pdfMake.createPdf(documentDefinition).download(
      `${letter.keteranganUsaha.nama}_SuratKeteranganUsaha.pdf`
    );
  };
...
export default SpesificLetterUsaha