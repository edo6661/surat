...
import SpesificLetterBelumMenikah from '../../_components/SpesificLetterBelumMenikah';
            ...
            <div className='space-y-4'>
              ...
              <div className="">
                <div className="space-y-2 my-2">
                  <p>Dengan hormat,</p>
                  <p>Sehubungan dengan rencana kami untuk membuat Keterangan Belum Menikah, kami yang bertanda tangan di bawah ini:</p>
                </div>
                <p>Nama: {letter.keteranganBelumMenikah.nama}</p>
                <p>NIK: {letter.keteranganBelumMenikah.nik}</p>
                <p>Tempat Lahir: {letter.keteranganBelumMenikah.tempatLahir}</p>
                <p>Tanggal Lahir: {formatDate(letter.keteranganBelumMenikah.tanggalLahir)}</p>
                <p>Agama: {letter.keteranganBelumMenikah.agama}</p>
                <p>Pekerjaan: {letter.keteranganBelumMenikah.pekerjaan}</p>
                <p>Alamat: {letter.keteranganBelumMenikah.alamat}</p>
              </div>
