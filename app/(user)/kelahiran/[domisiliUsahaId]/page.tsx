...
import SpesificLetterKelahiran from '../../_components/SpesificLetterKelahiran';
            ...
            <div className='space-y-4'>
              ...
              <div className="">
                <div className="space-y-2 my-2">
                  <p>Dengan hormat,</p>
                  <p>Sehubungan dengan kelahiran anak kami di {letter.kelahiran.tempatLahir}, kami yang bertanda tangan di bawah ini:</p>
                </div>
                <p>Nama Ayah: {letter.kelahiran.namaAyah}</p>
                <p>Tempat, Tanggal Lahir Ayah: {letter.kelahiran.tempatLahirAyah}, {formatDate(letter.kelahiran.tanggalLahirAyah)}</p>
                <p>Agama Ayah: {letter.kelahiran.agamaAyah}</p>
                <p>Pekerjaan Ayah: {letter.kelahiran.pekerjaanAyah}</p>
                <p>Nama Ibu: {letter.kelahiran.namaIbu}</p>
                <p>Tempat, Tanggal Lahir Ibu: {letter.kelahiran.tempatLahirIbu}, {formatDate(letter.kelahiran.tanggalLahirIbu)}</p>
                <p>Agama Ibu: {letter.kelahiran.agamaIbu}</p>
                <p>Pekerjaan Ibu: {letter.kelahiran.pekerjaanIbu}</p>
                <p>Jenis Kelamin Anak: {letter.kelahiran.jenisKelamin}</p>
                <p>Tempat, Tanggal Lahir Anak: {letter.kelahiran.tempatLahir}, {formatDate(letter.kelahiran.tanggalLahir)}</p>
                <p>Agama: {letter.kelahiran.agama}</p>
