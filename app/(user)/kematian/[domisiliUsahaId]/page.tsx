...
import SpesificLetterKematian from '../../_components/SpesificLetterKematian';
            ...
            <div className='space-y-4'>
              ...
              <div className="">
                <div className="space-y-2 my-2">
                  <p>Dengan hormat,</p>
                  <p>Sehubungan dengan kematian {letter.kematian.nama} yang terjadi di {letter.kematian.tempatKematian}, kami yang bertanda tangan di bawah ini:</p>
                </div>
                <p>Nama: {letter.kematian.nama}</p>
                <p>NIK: {letter.kematian.nik}</p>
                <p>Tanggal Lahir: {formatDate(letter.kematian.tanggalLahir)}</p>
                <p>Tanggal Kematian: {formatDate(letter.kematian.tanggalKematian)}</p>
                <p>Tempat Lahir: {letter.kematian.tempatLahir}</p>
                <p>Jenis Kelamin: {letter.kematian.jenisKelamin}</p>
                <p>Alamat: {letter.kematian.alamat}</p>
                <p>Agama: {letter.kematian.agama}</p>
                <p>Pekerjaan: {letter.kematian.pekerjaan}</p>
                <p>Alamat Kematian: {letter.kematian.alamatKematian}</p>
                <p>Tempat Kematian: {letter.kematian.tempatKematian}</p>
              </div>
