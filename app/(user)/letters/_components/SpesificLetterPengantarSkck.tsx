...
interface SpesificLetterPengantarSkckProps {
  letter: any;
  role: Role
}

const SpesificLetterPengantarSkck = (
  { letter, role }: SpesificLetterPengantarSkckProps
) => {

  const generatePdf = async () => {
    if (!letter || !letter.pengantarSKCK) return;
    ...
    const documentDefinition = {
      ...
      content: [
        ...
        { text: 'Surat Pengantar SKCK', style: 'subheader', alignment: 'center', decoration: 'underline' },
  ...
  Kota Tangerang, menerangkan dengan sebenarnya kepada:`,
        ...
        { text: `Nama: ${letter.pengantarSKCK.nama}`, style: 'normal', margin: [16, 12, 0, 0] },
        { text: `NIK: ${letter.pengantarSKCK.nik}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Jenis Kelamin: ${letter.pengantarSKCK.jenisKelamin}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tempat Lahir: ${letter.pengantarSKCK.tempatLahir}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Tanggal Lahir: ${formatDate(letter.pengantarSKCK.tanggalLahir)}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Alamat: ${letter.pengantarSKCK.alamat}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Pekerjaan: ${letter.pengantarSKCK.pekerjaan}`, style: 'normal', margin: [16, 8, 0, 0] },
        { text: `Keperluan: ${letter.pengantarSKCK.keperluan}`, style: 'normal', margin: [16, 8, 0, 0] },
    ...
    pdfMake.createPdf(documentDefinition).download(
      `${letter.pengantarSKCK.nama}_SuratPengantarSKCK.pdf`
    );
  };
...
export default SpesificLetterPengantarSkck