...
import SpesificLetterTinggalPenduduk from '../../_components/SpesificLetterTinggalPenduduk';
    ...
    <section className='base-container'>
      ...
      {letter ? (
        <>
          ...
          {letter.tinggalPenduduk && (
            <div className='space-y-4'>
              <Heading as="h4" size="sm" className='text-center'>
                Surat Tinggal Penduduk
              </Heading>
              <div className="">
                <div className="space-y-2 my-2">
                  <p>Dengan hormat,</p>
                  <p>Sehubungan dengan rencana kami untuk Tinggal Penduduk, kami yang bertanda tangan di bawah ini:</p>
                </div>
                <p>Nama Pemohon: {letter.tinggalPenduduk.nama}</p>
                <p>NIK: {letter.tinggalPenduduk.nik}</p>
                <p>Tempat Lahir: {letter.tinggalPenduduk.tempatLahir}</p>
                <p>Tanggal Lahir: {formatDate(letter.tinggalPenduduk.tanggalLahir)}</p>
                <p>Alamat Asal: {letter.tinggalPenduduk.alamatAsal}</p>
                <p>Alamat Sekarang: {letter.tinggalPenduduk.alamatSekarang}</p>
