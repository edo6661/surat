...
import SpesificLetterUsaha from '../../_components/SpesificLetterUsaha';
            ...
            <div className='space-y-4'>
              ...
              <div className="">
                <div className="space-y-2 my-2">
                  <p>Dengan hormat,</p>
                  <p>Sehubungan dengan rencana kami untuk membuka usaha di {letter.keteranganUsaha.lokasiUsaha}, kami yang bertanda tangan di bawah ini:</p>
                </div>
                <p>Nama Pemilik Usaha: {letter.keteranganUsaha.nama}</p>
                <p>Alamat Usaha: {letter.keteranganUsaha.alamat}</p>
                <p>Jenis Usaha: {letter.keteranganUsaha.jenisUsaha}</p>
                <p>Nama Usaha: {letter.keteranganUsaha.namaUsaha}</p>
                <p>NIK: {letter.keteranganUsaha.nik}</p>
              </div>
